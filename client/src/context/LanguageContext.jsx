...
const translations = {
    en: {
        ...
        heroSubDesc: 'Emergency QR stores the details that matter in a calm, readable profile. One scan reveals blood group, emergency contact, medical notes, and responder instructions instantly.',
        ...
        feature1Copy: 'Responders land directly on the emergency profile without any app install or login.',
        feature2Title: 'Call fast',
        feature2Copy: 'Primary contact and backup number are visible above the fold for immediate action.',
        feature3Title: 'Medical first',
        feature3Copy: 'Blood group, allergies, medications, and notes are prioritized for real emergency use.',

        fastSetupBadge: 'Fast setup',
        buildPassTitle: 'Build the pass in under two minutes.',
        buildPassDesc: 'Create the profile once, download the QR, and keep it on your phone, wallet card, or lock screen. The public page only shows emergency-safe details.',
        ...
        bestUse: 'Best use',
        bestUseDesc: 'Keep this on your lock screen, wallet card, or medical ID so a scanner can reach the emergency page immediately.',
        ...
        emergencyDetailsArranged: 'Emergency details are arranged for immediate action: call contact first, then verify blood group and medical alerts.',
    ...
    hi: {
        ...
        heroSubDesc: 'आपातकालीन QR उन विवरणों को एक शांत, पढ़ने योग्य प्रोफ़ाइल में संग्रहीत करता है जो मायने रखते हैं। एक स्कैन से रक्त समूह, आपातकालीन संपर्क, चिकित्सा नोट्स और प्रतिक्रिया निर्देश तुरंत सामने आ जाते हैं।',
        ...
        feature1Copy: 'प्रतिसादकर्ता बिना किसी ऐप इंस्टॉल या लॉगिन के सीधे आपातकालीन प्रोफ़ाइल पर आते हैं।',
        feature2Title: 'जल्दी कॉल करें',
        feature2Copy: 'प्राथमिक संपर्क और बैकअप नंबर तत्काल कार्रवाई के लिए शीर्ष पर दिखाई देते हैं।',
        feature3Title: 'चिकित्सा पहले',
        feature3Copy: 'रक्त समूह, एलर्जी, दवाएं और नोट वास्तविक आपातकालीन उपयोग के लिए प्राथमिकता दी जाती हैं।',

        fastSetupBadge: 'त्वरित सेटअप',
        buildPassTitle: 'दो मिनट से भी कम समय में पास बनाएं।',
        buildPassDesc: 'एक बार प्रोफ़ाइल बनाएं, QR डाउनलोड करें और इसे अपने फोन, वॉलेट कार्ड या लॉक स्क्रीन पर रखें। सार्वजनिक पृष्ठ केवल आपातकालीन-सुरक्षित विवरण दिखाता है।',
        ...
        createHint1: 'केवल आपातकालीन-सुरक्षित डेटा सार्वजनिक रूप से दिखाया जाता है।',
        ...
        bestUseDesc: 'इसे अपनी लॉक स्क्रीन, वॉलेट कार्ड या मेडिकल आईडी पर रखें ताकि स्कैनर तुरंत आपातकालीन पृष्ठ तक पहुंच सके।',
        ...
        emergencyDetailsArranged: 'आपातकालीन विवरण तत्काल कार्रवाई के लिए व्यवस्थित हैं: पहले संपर्क को कॉल करें, फिर रक्त समूह और चिकित्सा अलर्ट सत्यापित करें।',
    ...
    gu: {
        ...
        heroSubDesc: 'ઇમરજન્સી QR એ વિગતોને શાંત, વાંચી શકાય તેવી પ્રોફાઇલમાં સંગ્રહિત કરે છે જે મહત્વપૂર્ણ છે. એક સ્કેન બ્લડ ગ્રુપ, કટોકટી સંપર્ક, તબીબી નોંધો અને પ્રતિભાવ સૂચનાઓ તરત જ છતી કરે છે.',
        ...
        feature1Copy: 'રિસ્પોન્ડર્સ કોઈપણ એપ્લિકેશન ઇન્સ્ટોલ અથવા લોગિન વિના સીધા જ કટોકટી પ્રોફાઇલ પર પહોંચે છે.',
        feature2Title: 'ઝડપથી કૉલ કરો',
        feature2Copy: 'પ્રાથમિક સંપર્ક અને બેકઅપ નંબર તાત્કાલિક પગલાં માટે ટોચ પર દૃશ્યમાન છે.',
        feature3Title: 'મેડિકલ પ્રથમ',
        feature3Copy: 'બ્લડ ગ્રુપ, એલર્જી, દવાઓ અને નોંધોને વાસ્તવિક કટોકટીના ઉપયોગ માટે પ્રાથમિકતા આપવામાં આવે છે.',

        fastSetupBadge: 'ઝડપી સેટઅપ',
        buildPassTitle: 'બે મિનિટથી ઓછા સમયમાં પાસ બનાવો.',
        buildPassDesc: 'એકવાર પ્રોફાઇલ બનાવો, QR ડાઉનલોડ કરો અને તેને તમારા ફોન, વૉલેટ કાર્ડ અથવા લૉક સ્ક્રીન પર રાખો. સાર્વજનિક પૃષ્ઠ ફક્ત કટોકટી-સુરક્ષિત વિગતો બતાવે છે.',
        ...
        bestUseDesc: 'આને તમારી લોક સ્ક્રીન, વૉલેટ કાર્ડ અથવા મેડિકલ આઈડી પર રાખો જેથી સ્કેનર તરત જ કટોકટી પૃષ્ઠ પર પહોંચી શકે.',
        ...
        emergencyDetailsArranged: 'કટોકટીની વિગતો તાત્કાલિક પગલાં માટે ગોઠવવામાં આવી છે: પહેલા સંપર્કને કૉલ કરો, પછી બ્લડ ગ્રુપ અને તબીબી ચેતવણીઓ ચકાસો.',
