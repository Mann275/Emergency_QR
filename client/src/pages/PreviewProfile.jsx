    ...
    <div className="min-h-screen pb-[calc(10rem+env(safe-area-inset-bottom))] sm:pb-16">
      <section className="pt-24 sm:pt-32">
        <div className="main-wrap max-w-5xl">
          <div className="mb-6 px-4 sm:px-6 text-left">
            <p className="text-sm sm:text-base font-bold text-[var(--ink)] opacity-80">
              {t.previewNote ||
              ...
              <div className="flex flex-col h-full justify-between">
                ...
                <div className="mt-5 flex flex-col min-[480px]:flex-row gap-2.5">
                  ...
                  >
                    ...
                    <span>{t.previewCallSelf || "Call personal number"}</span>
                  </button>
                </div>
              </div>
            </GlassCard>
